...
<div class="col-lg-8 mt-5"> 
  <button type="button" class="btn btn-primary">
    ...
    <form method="post" action="/dashboard/schedules" >
        @csrf
        <div class="mb-3">
        ...
        <div class="mb-3">
            ...
            required autofocus value="{{ old('date') }}">
            @error('date')
            <div class="invalid-feedback">
                {{ $message }}
            </div>
        ...
        <div class="mb-3">
            ...
            required autofocus value="{{ old('start_time') }}">
            @error('start_time')
            <div class="invalid-feedback">
                {{ $message }}
            </div>
        ...
        <div class="mb-3">
            ...
            required autofocus value="{{ old('end_time') }}">
            @error('end_time')
            <div class="invalid-feedback">
                {{ $message }}
            </div>
